...
const HelpModal: FunctionComponent<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal
      ...
      className="bg-bluishGray rounded-md max-w-[600px] min-h-[475px] mx-auto mt-[32px] p-[32px]"
      overlayClassName="fixed inset-0 bg-black bg-opacity-50 overflow-auto px-[20px]"
    >
      <div className="help-wrapper relative">
        ...
        <h2>Help</h2>
        <h3>Setting up OBS Studio</h3>
        <p>
          To use this control panel as inteded you will need to have{" "}
          <a href="https://obsproject.com/download">OBS Studio</a> and the
          plugins{" "}
        ...
        <p className="font-bold">
          The latest version of OBS Studio comes with obs-websocket
          preinstalled, meaning you only have to install it for older versions
          of OBS.
        </p>
        <h3>Scenes and sources in OBS Studio</h3>
        <p>
          The control panel expects your scenes and sources to be set up a
          certain way inside OBS and will not work as intended unless scenes and
          sources have been set up in the way it expects.
        </p>
        <h4>Importing an existing scene collection</h4>
        <p>
          If your scenes and sources have already been set up once (like our
          camera system for example) it's easiest to add them by importing them
          as a scene collection from a file.
        </p>
        <p>
          To import a scene collection hover over the scene collection tab of
          OBS' top menu and click on Import.
          <img
        ...
        <p id="scene-collection-description">
          ...
          The master scene has a scene source for each of the nested scenes.
          Each nested scene has one or more video sources, which each have a
          single source record filter named "Source Record" (case sensetive)
          with its record mode set to "recording".
        </p>
        <h3>Setting up OBS WebSocket server</h3>
        <p>
          ...
          <ol className="list-decimal list-inside">
            ...
            <li>
              set a secure password or let OBS generate one by erasing the text
              in the password field and then pressing the generate button next
              to it
            </li>
        ...
        <p>
          The OBS WebSocket server should now automatically start when OBS
          starts.
        </p>
        <h2>Connecting the control panel to OBS</h2>
        <p>
          <ol className="list-decimal list-inside">
            <li>open OBS and select your master scene</li>
            <li>
              Open the control panel. It will automatically try and connect to
              OBS without a password incase you did not feel the need to set
              one. If you did set a password you will see these three error
              messages:
              <img
            ...
            <li>
              Click on the "Open connection settings" button on the control
              panel, enter the password for the OBS WebSocket server, press
              "save" and then "close".
            </li>
          </ol>
        ...
        <p>
          ...
          sources load you will get a success message saying that the master
          scene was loaded.
        </p>
      </div>
    </Modal>
